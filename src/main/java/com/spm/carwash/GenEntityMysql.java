...
public class GenEntityMysql {
    ...
    private static final String URL = "jdbc:mysql://ss.xieyangzhe.com:3306/carwash?useUnicode=true&characterEncoding=utf-8";
    private static final String NAME = "carwash";
    private static final String PASS = "1234five";
